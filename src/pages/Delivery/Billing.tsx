  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center">
        <div className="bg-white shadow-default m-5 p-4 rounded-md text-start w-full max-w-3xl">
          ...
          <form>
            <div className="mb-9">
              <h4 className="font-semibold mb-3">Address line 1</h4>
            ...
            <div className="mb-9">
              <h4 className="font-semibold mb-3">Address line 2</h4>
            ...
            <div className="mb-9">
              <h4 className="font-semibold mb-3">Address line 3</h4>
