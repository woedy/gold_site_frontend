    ...
    <>
      ...
      <div className="grid grid-cols-3">
        ...
        <div className="col-span-1 bg-white shadow-default m-5 p-4 rounded-md text-center">
          <button
            className="flex justify-center w-full rounded border border-stroke py-2 px-6 font-medium text-black hover:shadow-1 dark:border-strokedark dark:text-white"
            type="submit"
          >
            Select All Products
          </button>
