      ...
      <div className="grid grid-cols-2 gap-6"> {/* Adjusted gap */}
        <div className="col-span-1">
          <div className="flex gap-4 justify-start items-center mb-4">
            ...
            Gold securely sealed in tamper-proof container            </h3>
          </div>
          <div className="flex gap-4 justify-start items-center mb-4">
            <div className="w-3 h-3 bg-graytrans rounded"></div>
            <h3 className="text-gray-800">Weight and purity double-checked</h3>
          </div>
          <div className="flex gap-4 justify-start items-center mb-4">
            <div className="w-3 h-3 bg-graytrans rounded"></div>
            <h3 className="text-gray-800">
            Insurance documentation completed           </h3>
          </div>
        </div>
        <div className="col-span-1">
          <div className="flex gap-4 justify-start items-center mb-4">
            <div className="w-3 h-3 bg-graytrans rounded"></div>
            <h3 className="text-gray-800">
            Shipping label generated            </h3>
          </div>
          <div className="flex gap-4 justify-start items-center mb-4">
            <div className="w-3 h-3 bg-graytrans rounded"></div>
            <h3 className="text-gray-800">Ready for secure transport</h3>
          </div>
        </div>
      </div>
    </div>
