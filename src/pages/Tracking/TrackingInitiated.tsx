...
const TrackingInitiated: React.FC = () => {
      ...
      <div className="grid grid-cols-2 gap-6"> {/* Adjusted gap */}
        <div className="col-span-1">
          ...
          <div className="flex gap-4 justify-start items-center mb-4">
            ...
            <h3 className="text-gray-800">Shipping preparation begins</h3>
          </div>
          <div className="flex gap-4 justify-start items-center mb-4">
            <div className="w-3 h-3 bg-graytrans rounded"></div>
            <h3 className="text-gray-800">
        ...
        <div className="col-span-1">
          <div className="flex gap-4 justify-start items-center mb-4">
            <div className="w-3 h-3 bg-graytrans rounded"></div>
            <h3 className="text-gray-800">
              Gold asset verified and packaged
            </h3>
          </div>
          <div className="flex gap-4 justify-start items-center mb-4">
            <div className="w-3 h-3 bg-graytrans rounded"></div>
            <h3 className="text-gray-800">Awaiting courier pickup</h3>
          </div>
        </div>
      </div>
    </div>
