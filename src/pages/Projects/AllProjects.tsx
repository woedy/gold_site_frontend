  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        `${baseUrl}api/projects/admin/get-all-projects/?search=${encodeURIComponent(
          search,
        ...
        ? projects.map((project) => (
            ...
            >
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                    <div className="h-12 w-12 overflow-hidden rounded-md">
                      <img
                        src={`${baseUrlMedia}${project.project_image}`}
                        alt="Project"
              ...
              <div className="col-span-2 hidden items-center sm:flex">
                <p className="text-sm text-black dark:text-white">
                  {truncateText(project.details, 50)}{' '}
                ...
                <p className="text-sm text-black dark:text-white">
                  <div className="flex items-center space-x-3.5">
                    <button className="hover:text-primary">
                      <Link to={'/project-details/' + project.project_id}>
                        <svg
                    ...
                    <button
                      ...
                      onClick={() => openDeleteModal(project.project_id)} // Pass the ID of the item to be deleted
                    >
                      <svg
                        className="fill-current"
                        width="18"
