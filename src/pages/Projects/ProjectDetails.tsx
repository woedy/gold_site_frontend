...
const ProjectDetails = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(
          baseUrl + `api/projects/get-project-details/?project_id=${project_id}`,
          {
            headers: {
        ...
        setProjectImages(data.data.project_images);
        setProjectVideos(data.data.project_videos);
      } catch (error) {
  ...
  const handlePublish = async (e) => {
    ...
    const url = baseUrl + 'api/projects/post-project/';
    const data = {
      ...
      <div className="grid grid-cols-2 gap-8">
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="relative z-20 h-35 md:h-65">
            <img
              src={`${baseUrlMedia}/media/${projectImages[0]}`}
              alt="profile cover"
...
<div className="flex gap-2 absolute bottom-1 left-1 z-10 xsm:bottom-4 xsm:left-4">
              ...
              >
                ...
                <span>{ project.draft === true ? 'Publish' : 'Draft'}</span>
              </label>
...
<Link to={'/add-project-images/' + project.project_id}>
<label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-primary py-1 px-2 text-sm font-medium text-white hover:bg-opacity-90 xsm:px-4"
            >
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="grid grid-cols-2 mb-5">
                <div className="mx-auto max-w-180 mt-3">
                  ...
                  <p className="mt-4 text-4xl font-bold text-primary">{project.target || 'N/A'}</p>
                </div>
                ...
                <div className="mx-auto max-w-180 mt-3">
                  ...
                  <p className="mt-4 text-4xl font-bold text-primary">{project.raised || '0'}</p>
                </div>
              </div>
              ...
              <p className="font-medium">{project.details || 'N/A'}</p>
