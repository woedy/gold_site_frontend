...
const AddProject = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (projectTitle === '') {
      setInputError('Project title required.');
      return;
    }
    ...
    if (projectDetails === '') {
      setInputError('Project Subject required.');
      return;
    }
    ...
    if (projectTarget === '') {
      setInputError('Project Venue required.');
      return;
    }
    ...
    formData.append('target', projectTarget);

    // Make a POST request to the server
    const url = baseUrl + 'api/projects/add-project/';
    ...
    try {
      ...
      navigate('/all-projects'); // Navigate to success page
    } catch (error) {
