...
const AllProducts = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        `${baseUrl}api/shop/admin/get-all-products/?search=${encodeURIComponent(
          search,
  ...
  const handleDelete = async (itemId) => {
    ...
    try {
      const response = await fetch(`${baseUrl}api/products/delete-product/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Token ${userToken}`,
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                    <div className="h-12 w-12 overflow-hidden rounded-md">
                      <img
                        src={`${baseUrlMedia}${product.product_image}`}
                        alt="Product"
                ...
                <p className="text-sm text-black dark:text-white">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <button
                      ...
                      onClick={() => openDeleteModal(product.product_id)} // Pass the ID of the item to be deleted
                    >
                      <svg
                        className="fill-current"
                        width="18"
